...
if "notification" in settings.INSTALLED_APPS:
    ...
    def create_notice_types(app, created_models, verbosity, **kwargs):
        ...
        notification.create_notice_type("comment_posted", _(
            "Comment Posted"), _("You have posted a comment"), default=1)
        ...
        notification.create_notice_type("comment_friend_posted", _(
            "Friend Posted Comment"), _("A friend has posted a comment"), default=1)
        notification.create_notice_type("comment_friend_replied", _(
            "Friend Replied To Comment"), _("A friend has replied to a comment"), default=1)
